...
$(document).ready(function () {
  ...
  $(".grp-header__hamburger").click(function () {
    $(".grp-header__nav").slideDown().css("display", "flex");
  });

  $(".grp-header__nav .close").click(function () {
    $(".grp-header__nav").slideUp();
  });
  ...
  function initZoom() {
    $(".grp-product-image__zoom").zoom({
      url: $(".grp-product-image__zoom").data("zoom"),
    });
  }
  initZoom();

  $(".grp-product-image__thumbs .thumbnail").click(function () {
    var url = $(this).data("url");
    $(".grp-product-image__zoom")
  ...
  $(".grp-mobile-image__thumbs .thumbnail").click(function () {
    var url = $(this).data("url");
    $(".grp-mobile-image__canvas").css("background-image", "url(" + url + ")");
  });
